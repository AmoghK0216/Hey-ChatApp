          ...
          {user ? (
            <>
              <div className="relative">
                ...
                {/* online user setup after socket */}
                {isOnlineUser && (
                  <span className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-green-500 border-2 border-gray-800">
                    <span className="absolute inset-0 rounded-full bg-gray-500 animate-ping opacity-75"></span>
                  </span>
                )}
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Choose Chat from the Sidebar to start Messaging
                </p>
              </div>
            </div>
          )}
