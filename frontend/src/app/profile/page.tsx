      ...
      <div className="max-w-2xl mx-auto pt-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-1">Manage Your Account Info</p>
          </div>
        </div>

        <div className="bg-gray-800 rounded-lg border border-gray-700 shadow-lg">
          <div className="bg-gray-700 p-8 border-b border-gray-600 rounded-lg">
              ...
              <div>
                ...
                {isEdit ? (
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-700 rounded-lg border border-gray-600">
                    ...
                    <button
                      onClick={editHandler}
                      className="flex items-center gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-800 text-white font-semibold rounded-lg"
                    >
                      Edit
                    </button>
                  </div>
